...
const UserSchema = CollectionSchema(
  name: r'User',
  schema:
      r'{"name":"User","idName":"id","properties":[{"name":"age","type":"Long"},{"name":"name","type":"String"}],"indexes":[{"name":"name","unique":true,"replace":false,"properties":[{"name":"name","type":"Hash","caseSensitive":true}]}],"links":[]}',
  idName: r'id',
  propertyIds: {r'age': 0, r'name': 1},
  listProperties: {},
  indexIds: {r'name': 0},
  indexValueTypes: {
    r'name': [
...
Object _userSerializeWeb(IsarCollection<User> collection, User object) {
  ...
  IsarNative.jsObjectSet(jsObj, r'age', object.age);
...
User _userDeserializeWeb(IsarCollection<User> collection, Object jsObj) {
  final object = User(
    age: IsarNative.jsObjectGet(jsObj, r'age') ??
...
P _userDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
    case r'age':
      return (IsarNative.jsObjectGet(jsObj, r'age') ??
...
extension UserByIndex on IsarCollection<User> {
  ...
  Future<int> putByName(User object) {
    return putByIndex(r'name', object);
  }

  int putByNameSync(User object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<int>> putAllByName(List<User> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<int> putAllByNameSync(List<User> objects, {bool saveLinks = true}) {
